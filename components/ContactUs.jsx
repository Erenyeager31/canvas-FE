  ...
  return (
    ...
    //   </div>
      ...
      <div className="flex flex-col items-center justify-start bg-white">
        {/* Header */}
        <div
          className="w-full text-center flex-grow flex items-center justify-center text-white text-4xl font-bold tracking-wide"
          style={{
      ...
      <div className="w-11/12 md:w-1/2 lg:w-1/3 bg-white mt-10 shadow-md rounded-lg p-6">
        <form className="space-y-4">
          ...
          <div className="flex items-center space-x-2 rounded-2xl p-2 bg-[#D9D9D9] transition-transform transform hover:scale-105">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" className="w-6 h-6 bg-[#D9D9D9] ">
          ...
          {/* <div className="flex items-center space-x-2 rounded-md p-2 ">
            ...
            <div className="flex items-center space-x-2 rounded-2xl p-2 bg-[#D9D9D9] transition-transform transform hover:scale-105">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-6 h-6 text-[#6a3a9f] bg-[#D9D9D9]">
